...
import {
  ...
  passwordIsSecure,
} from "../helpers/password-validation.helpers";
      ...
      <Box>
        <List>
          <ListItem>
            ...
            <Typography
              sx={{ color: passwordIsNotTooShort(password) ? "green" : "red" }}
            >
          ...
          <ListItem>
            <CircleIcon fontSize="small" />
            <Typography
              sx={{ color: containsUpperCase(password) ? "green" : "red" }}
            >
          ...
          <ListItem>
            <CircleIcon fontSize="small" />
            <Typography
              sx={{ color: containsNumbers(password) ? "green" : "red" }}
            >
          ...
          <ListItem>
            <CircleIcon fontSize="small" />
            <Typography
              sx={{ color: containsSpecialChar(password) ? "green" : "red" }}
            >
